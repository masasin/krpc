...
class TestClient(ServerTestCase, unittest.TestCase):
    ...
    def test_value_parameters(self):
        ...
        self.assertEqual('123456789000', self.conn.test_service.int64_to_string(123456789000))
    ...
    def test_test_service_enum_members(self):
        self.assertSetEqual(
            ...
            set([x for x in dir(self.conn.test_service.CSharpEnum) if not x.startswith('_')]))
